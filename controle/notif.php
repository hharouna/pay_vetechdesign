...
$parametre.= 'cpm_trans_id='.$cpm_trans_id;
...
if(empty($_transaction['transaction']['cpm_language'])): $_transaction['transaction']['cpm_language']="fr"; endif; 
	...
	":cpm_error_message"=>$_transaction['tra nsaction']['cpm_error_message'],
...
if(isset($_transaction['transaction']['cpm_custom']) && $_transaction['transaction']['cpm_result']=="00"):
$_message='<center> Echec de votre paiement merci !!!</centre> <hr>
						            <div>Information sur la session de formation: </div>'; 
					
//20-44-552-57-hharouna86@gmail.com-harouna-harouna
